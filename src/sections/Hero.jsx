    ...
    <section id="home" className=" w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container  ">
      <div className="relative xl:w-2/5 flex flex-col justify-center w-full items-start max-xl:padding-x mt-28">
        ...
        <h1 className="mt-10 font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-[83]">
          <span className="max-xl:bg-white xl:whitespace-nowrap font-bold relative z-10 pr-10">The  New Arrival</span>
          <br/>
      ...
      <div className="relative flex-1 flex justify-center  items-center xl:min-h-screen max:xl:py-40  bg-primary bg-hero bg-cover bg-center">
        <img src={bigShoe1} width={610} height={500} alt="" className="object-contain relative z-10 x" />
        <div>
          {shoes.map((shoe=>(
